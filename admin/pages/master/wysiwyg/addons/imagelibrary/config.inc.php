...
$pageDir = str_replace( 'master/wysiwyg/addons/imagelibrary', '', $dirpath);
if( file_exists( $pageDir . 'lib/var.inc.php' ) ) require_once( $pageDir . 'lib/var.inc.php' );

$bean = array();
if (function_exists( 'load_main_bean' )) $bean = load_main_bean();
 ...
 */
$imagebasedir = UPLOADSPATH.'/images';

/*
 * An absolute or relative URL to the image folder.
 * This url is used to generate the source of the image.
 */
$imagebaseurl = method_exists($bean, 'url') ? $bean->url('assets/uploads/images') : 'uploads';
