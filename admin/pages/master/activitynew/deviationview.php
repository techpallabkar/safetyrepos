...
<div class="container1">
    <h1 class="heading">Deviation : <span class="text-primary"><?php echo $activities; ?></span></h1>
        ...
        <form name="create_post" id="create_post" action="" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-bordered2" style="background:#a3e4d7; ">
                <tbody>
                    <tr>
                        ...
                        <td colspan="2">
                            <b>SWP/WI Violation</b>
                        </td>
                    </tr>
                    <tr>
                        <td class="bgari-1"><b>Description : </b></td>
                        <td colspan="6">
                            <b>Working at Height - All personnel at height used double lanyard Safety Harness property including anchoring. Fall Arrestor / Life line is used , if required. Scaffolding rules are followed / Properly erected. Use of Double lanyard during climbing.</b>
                        </td>
                    </tr>
                    <tr>
                    </tr>
                    <tr>
                        ...
                        <td width="15%"><b>Intermediate</b></td>
                        ...
                        <td width="10%">
                            <a class="btn btn-success btn-xs">Update</a>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table">
                <tr>
                    ...
                    <td width="60%">
                        <textarea name="data[]" id="" value="" class="width100"></textarea>
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 15%;">File Upload :</td>
                                <td style="width: 85%;"><input type="file" /></td>
                            </tr>
                            <tr>
                                <td style="width: 15%;">Caption :</td>
                                <td style="width: 85%;"><input type="text" style="width: 100%; margin-top: 8px;" /></td>
                            </tr>
                        </table>
                    </td>
                    <td width="20%" style="vertical-align: bottom;"><a class="btn btn-success btn-show"><i class="fa fa-plus"></i></a></td>
                </tr>
                <tr>
            ...
            <p class="text-center"><a class="btn btn-success">Post</a><a class="btn btn-danger">Cancel</a></p>
            <table class="table">
                <tr>
