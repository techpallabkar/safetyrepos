...
<div class="container1">
	...
	<div class="holder2 col-md-8" id="rightform2">
		...
		<div class="holder">
			...
			<input type="text" id="tags" value="" placeholder="Tags" autocomplete="off" />
			<?php
			if( ! in_array($status_id , array(3, 5) ) ) {
				echo '<input type="button" id="add_tag" value="Add" class="btn btn-sm btn-primary" />'."\n";
			}
			?>
			<input type="hidden" name="data[tag_keys]" id="tag_keys" value="<?php echo $tag_keys; ?>" />
		</div>
		<div id="suggesstion-box"></div>
		<div id="all_tags"><?php echo load_tag_html( $tag_keys, $status_id ); ?></div>
		<br />
		
		<div class="holder required">
			<fieldset>
				<legend>Upload E-book</legend>
				<?php
				$pdf_link_html 	= "";
