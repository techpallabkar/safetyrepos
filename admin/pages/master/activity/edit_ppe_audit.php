...
<script>
    ...
    $(document).ready(function () {
            ...
            type: 'post',
                    cache: false,
                    data:{"action": "getSasImageDetailsForPPE", "sas_report_no": sas_report_no},
                    success: function (data) {
...
//                          alert( index + ": " + obj[index].file_path );
                        ...
                        var image_caption   = obj[index].name;
                            img += '<div style="float:left;width:150px;"><img src="<?php echo MIS_IMAGE_PATH_PPE; ?>' + image_name + '" higth="140" width="120"><br>'+image_caption+'</div>';
