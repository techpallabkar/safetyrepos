...
<?php echo $beanUi->get_message(); ?>
    <h1 class="heading">Monthly Report  ( <?php if ($_REQUEST["st"] == "A") { echo "Approved"; } else { echo "Not Approved"; } ?> ) 
...
<?php if ($_REQUEST["st"] == "A") { ?>
             ...
             <table border="1" id="fixTable" class="table table-bordered table-condensed table-striped" style="font-size: 11px;">
                    <thead>
                        ...
                        <tr>
                            <td width="7%" bgcolor="#fff">Status</td>                           
...
<?php } else { ?>
                <table border="1" id="fixTable" class="table table-bordered table-condensed table-striped" style="font-size: 11px;">
                    <thead>
                       <tr class="bg-primary" >
                        ...
                        <tr class="bg-primary">
                            ...
                            foreach ($allActivity as $rowdata) {
                                if ($rowdata->id != 9 && $rowdata->id != 10) {
                                    echo '<th width="15%" colspan="2">' . $rowdata->activity_name . '</th>';
                                }
                            }
                            ?>
                        </tr>
                    ...
                    <tfoot style="backgroung-color:#fff;">
                        ...
                        <tr>
                            <td bgcolor="#FF9F08" style="font-weight: bold;font-size:15px;width:15%;">Grand Total</td>
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total1 + $total11 + $total111); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total2 + $total22 + $total222); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total3 + $total33 + $total333); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total4 + $total44 + $total444); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total5 + $total55 + $total555); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total6 + $total66 + $total666); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total7 + $total77 + $total777); ?></td> 
                            <td colspan="2" style="text-align: center;font-weight: bold;font-size:15px;"><?php echo ($total8 + $total88 + $total888); ?></td> 
                        </tr>
                    </tfoot>
                </table>
