            ...
            <tbody>
                ...
                <tr bgcolor="#cec8c7">
                    ...
                    <td style="width: 10%;">
                        ...
                        <input class="auto" data-a-sep="" data-m-dec="" type="text" name="gofficer<?php echo $key ?>" value="<?php echo $annual_target[$gen]->officer ?>" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gworkmanp<?php echo $key ?>" name="gworkmanp<?php echo $key ?>" value="<?php echo $annual_target[$gen]->pr_workman ?>" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gsupervisorp<?php echo $key ?>" name="gsupervisorp<?php echo $key ?>" value="<?php echo $annual_target[$gen]->pr_supervisor ?>" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gtotalp<?php echo $key ?>" name="gtotalp<?php echo $key ?>" value="<?php echo $annual_target[$gen]->pr_total ?>" readonly="readonly" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gworkmanc<?php echo $key ?>" name="gworkmanc<?php echo $key ?>" value="<?php echo $annual_target[$gen]->co_workman ?>" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gsupervisorc<?php echo $key ?>" name="gsupervisorc<?php echo $key ?>" value="<?php echo $annual_target[$gen]->co_supervisor ?>" style="width: 100%;"/></td>
                    <td style="width: 10%;"><input class="auto" data-a-sep="" data-m-dec="" type="text" id="gtotalc<?php echo $key ?>" name="gtotalc<?php echo $key ?>" value="<?php echo $annual_target[$gen]->co_total ?>" readonly="readonly" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="gsoblf<?php echo $key ?>" value="<?php echo $annual_target[$gen]->div_target_lf ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="gsod<?php echo $key ?>" value="<?php echo $annual_target[$gen]->div_target_day ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="gsw<?php echo $key ?>" value="<?php echo $annual_target[$gen]->div_target_work ?>" style="width: 100%;"/></td>
                </tr>
                <tr bgcolor="#cec8c7">
                    <td>DIST.</td>
                    <td>
                        ...
                        <input class="auto" data-a-sep="" data-m-dec="" type="text" name="dofficer<?php echo $key ?>" value="<?php echo $annual_target[$dist]->officer ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dworkmanp<?php echo $key ?>" name="dworkmanp<?php echo $key ?>" value="<?php echo $annual_target[$dist]->pr_workman ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dsupervisorp<?php echo $key ?>" name="dsupervisorp<?php echo $key ?>" value="<?php echo $annual_target[$dist]->pr_supervisor ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dtotalp<?php echo $key ?>" name="dtotalp<?php echo $key ?>" value="<?php echo $annual_target[$dist]->pr_total ?>" readonly="readonly" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dworkmanc<?php echo $key ?>" name="dworkmanc<?php echo $key ?>" value="<?php echo $annual_target[$dist]->co_workman ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dsupervisorc<?php echo $key ?>" name="dsupervisorc<?php echo $key ?>" value="<?php echo $annual_target[$dist]->co_supervisor ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" id="dtotalc<?php echo $key ?>" name="dtotalc<?php echo $key ?>" value="<?php echo $annual_target[$dist]->co_total ?>" readonly="readonly" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="dsoblf<?php echo $key ?>" value="<?php echo $annual_target[$dist]->div_target_lf ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="dsod<?php echo $key ?>" value="<?php echo $annual_target[$dist]->div_target_day ?>" style="width: 100%;"/></td>
                    <td><input class="auto" data-a-sep="" data-m-dec="" type="text" name="dsw<?php echo $key ?>" value="<?php echo $annual_target[$dist]->div_target_work ?>" style="width: 100%;"/></td>
                </tr>
