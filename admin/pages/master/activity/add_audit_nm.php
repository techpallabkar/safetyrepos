...
<div class="container1">
    <h1 class="heading">Add Activity : <span class="text-primary"><?php echo $activities; ?> Generation And Other Departments</span></h1>
...
<!--            <div class="holder">
                ...
                <input type="text"  name="data[sas_report_no]" id="sas_report_no" value="<?php echo $beanUi->get_view_data( "audit_duration" ); ?>" />
...
<?php   echo FILESIZE_ERROR;
        ...
        ?>
            ...
            <div class="holder required">
                ...
                <input type="text" class="auto" data-v-max="100.99" data-m-dec="2" name="data[avg_mark]" id="avg_mark" />
...
<script type="text/javascript" src="<?php echo url('assets/js/jqueryui/jquery-ui.js') ?>"></script>
    ...
    $( function() {
        ...
        $.ajax({
            type: 'post', url: '<?php echo page_link("activity/add_audit_nm.php"); ?>', cache: false,
            data: ajax_data,
