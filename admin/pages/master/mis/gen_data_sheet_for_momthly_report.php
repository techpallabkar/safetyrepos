...
<div class="container1">
    <h1 class="heading" style="border-bottom:3px solid #ff9f08;">17. GENERATION DATA SHEET FOR MONTHLY REPORT</h1> 
...
<div id='TBL_EXPORT'>
    <div class="print-friendly" id="divToPrint">
        <div class="none">
            <u>GENERATION DATA SHEET FOR MONTHLY REPORT</u>
            <br>
            <br>
        </div>
    <table class="table table-bordered table-bordered table-condensed" style="font-weight: bold;">
        ...
        <tr>
            <th width="5%" rowspan="2" style="vertical-align: middle;">SL</th>
            ...
            <th colspan="4" width="26.5%">FY' <?php 
                                ...
                                ?></th>
            <th colspan="4" width="26.5%">FY' <?php 
                                 $date = explode(",",$arr_date_send['last_year']); 
                                 echo date("Y",strtotime($date[0]))."-".date("Y",strtotime($date[1])); 
                                 ?></th>
        ...
        <tr>
            ...
            <th width="8%" style="vertical-align: middle;">YTM THIS YR</th>
        ...
        <?php
        foreach ($majorItem as $key => $value) {
        ...
        <div class="print1" style="float: left; color:#CA0000;">
                        NOTE : Based on Generation Data</td>
                    </div>
