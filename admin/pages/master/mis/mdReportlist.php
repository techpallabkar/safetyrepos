...
<div class="container1">
    ...
    <h1 class="heading">1. MD's Report List 
        <!--<a href="mdReport.php" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Add New</a><br>-->
                ...
                if (!empty($getmddata)) {
                    foreach ($getmddata as $key => $rowdata) {
                        ...
                        <td align="center">' . (($rowdata->status_id == 2) ?
                                "<a href='editmdReport.php?mnthyr=" . $rowdata->month_year . "&id=" . $rowdata->id . "&mode=view' class='btn btn-primary btn-xs'>View</a>" :
                                "<a href='editmdReport.php?mnthyr=" . $rowdata->month_year . "&id=" . $rowdata->id . "' class='btn btn-info btn-xs'>Edit</a>") . '</td>
                    </tr>';
                    }
                }
                ?>
