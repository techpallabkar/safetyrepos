...
<div class="container1">
    <h1 class="heading" style="border-bottom:3px solid #ff9f08;">23(A). C-SET DEPARTMENT WISE SET WISE AUDIT SCORE (DIST.) FOR MNTC </h1> 
    ...
    <form action="" method="post" id="fyr" enctype="multipart/form-data">
        ...
        <div class="col-sm-2">
            ...
            <a href="cset_deptwise_setwise_auditscore_MNTC.php" class="btn btn-danger btn-sm">Reset</a>
        </div>
    </form>
    <hr /> 
                ...
                <div class="print-friendly" id="divToPrint">
                    <table border="1" class="table table-bordered table-condensed table-responsive" style="font-size:13px;font-weight:bold; " >
                        <thead class="bg-primary">
                            <tr><th colspan="9"> C-SET DEPARTMENT WISE SET WISE AUDIT SCORE (DIST.) FOR MNTC </th></tr>
                            <tr>
