                ...
                if (!empty($getmcmdata)) {
                    foreach ($getmcmdata as $key => $rowdata) {
                        ...
                        <td align="center">' . (($rowdata->status_id == 2) ?
                                "<a href='editmcmReportNew.php?mnthyr=" . $rowdata->month_year . "&id=" . $rowdata->id . "&mode=view' class='btn btn-primary btn-xs'>View</a>" :
                                "<a href='editmcmReportNew.php?mnthyr=" . $rowdata->month_year . "&id=" . $rowdata->id . "' class='btn btn-info btn-xs'>Edit</a>") . '</td>
                    </tr>';
                    }
                }
                ?>
