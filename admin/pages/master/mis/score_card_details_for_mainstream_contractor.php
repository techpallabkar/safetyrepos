<?php
/* MIS Report No. : 08
 * Name         :   SCORE CARD DETAILS FOR MAINSTREAM CONTRACTORS
 * Controller   :   score_card_details_for_mainstream_contractor()
 * Dao          :   getAuditData
 * Created By Anima
 */
...
<div class="container1">
    ...
    <h1 class="heading">8. C-SETS (MAINS) SCORES-SORTED WITH TOP/BOTTOM COLOUR CODING
    ...
    <form action="" method="post" id="mdform" enctype="multipart/form-data" style="<?php //echo ( $mode == "view" ) ? 'display:none' : 'display:block'; ?>" >
        <div class="holder">
            ...
            <a href="score_card_details_for_mainstream_contractor.php" class="btn btn-danger btn-sm">Reset</a>                 
        </div>
        <hr class="no-margin"/>
    </form>
    ...
    <div class="wrapper2"> 
        ...
        <table class="table table-bordered">
            <thead class="bg-primary">
                <tr><th colspan="10"> C-SETS (MAINS) SCORES-SORTED WITH TOP/BOTTOM COLOUR CODING </th></tr>
            <tr>
                ...
                <th colspan="2">YTM [FY'<?php echo $current_year; ?>]</th>
            </tr>
            <tr>
                <th>% Avg.</th>
                <th>Score</th>
            ...
            <tbody align="center">
                ...
                echo '<th style="border:1px solid #000;">'.($i++).'.</th>
                    <th style="border:1px solid #000;"  align="center"><b>'.($key).'</b></th>
