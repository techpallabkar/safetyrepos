...
$activityStatics            =   $beanUi->get_view_data("activityStatics");
$getDate                    =   $beanUi->get_view_data("getDate");
$current_fy_month_arr       =   $beanUi->get_view_data("current_fy_month_arr");
$activity_category_id       =   $beanUi->get_view_data("activity_category_id");//show($activity_category_id);
...
<div class="container1">
    <h1 class="heading" style="border-bottom:3px solid #ff9f08;">30. UNIT WISE MONTH WISE ACTIVITY HISTORY
</h1> 
    ...
    <form action="" method="post" id="fyr" enctype="multipart/form-data">
        ...
        <div class="col-sm-2">
            ...
            <a href="district_wise_month_wise_activity_statistics.php" class="btn btn-danger btn-sm">Reset</a>
        </div>
    </form>
    <hr/>
    ...
    <div class="print1" style="float: right;">
        ...
        <table id="fixTable" border="1" class="table table-bordered table-condensed scrollTable totaldata" style="font-size:13px;" >
                <thead class="bg-primary fixedHeader">
                    <tr>
                        <th  colspan="16"> UNIT  WISE MONTH WISE ACTIVITY HISTORY</th>
                    </tr>
                    <tr class="bg-primary">
                        <th width="5%">SL.NO</th>
                        <th width="10%">DIST</th>
                ...
                <tbody class="scrollContent" style="font-size:10px;">
                    <?php
                    $color_array = array( 1 => "#91ffe9", 2 => "#ecff84", 4 => "#ffa789" , 5 => "#ccccff" , 6 => "#ffb3d9" , 7 => "#84bdff" , 8 => "#ffe27a");
                    if(!empty($activityStatics)) {
                        foreach ($activityStatics as $key => $value) {
                            $apr = $value['APR'];
                            $may = $value['MAY'];
                            $jun = $value['JUN'];
                            $jul = $value['JUL'];
