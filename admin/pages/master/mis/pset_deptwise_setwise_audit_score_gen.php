...
<div class="container1">
    <h1 class="heading" style="border-bottom:3px solid #ff9f08;">22. P-SET DEPARTMENT WISE SET WISE AUDIT SCORE (DIST.) </h1> 
    ...
    <form action="" method="post" id="fyr" enctype="multipart/form-data">
        ...
        <div class="col-sm-2">
            ...
            <a href="pset_deptwise_setwise_audit_score_gen.php" class="btn btn-danger btn-sm">Reset</a>
        </div>
    </form>
    <hr /> 
                ...
                <div class="print-friendly" id="divToPrint">
                    <table border="1" class="table table-bordered table-condensed table-responsive" style="font-size:13px;font-weight:bold; " >
                        <thead class="bg-primary">
                            <tr><th colspan="9"> P-SET DEPARTMENT WISE SET WISE AUDIT SCORE (DIST.) </th></tr>
                            <tr>
