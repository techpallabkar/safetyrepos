<?php
/* MIS Report No. : 12
 * Name         :   BBGS Contractors Scores -Sorted 
 * Controller   :   bbgs_contractors_scores_sorted()
 * Dao          :   get_contractor_list_Gen_Bbgs,getAllContractorbyCode_Gen_Bbgs
 * Created By pallab
 */
...
<div class="container1">
    ...
    <h1 class="heading">12.BBGS Contractors Scores -Sorted
    ...
    <form action="" method="post" id="mdform" enctype="multipart/form-data" style="<?php //echo ( $mode == "view" ) ? 'display:none' : 'display:block'; ?>" >
        <div class="holder">
            ...
            <a href="bbgs_contractors_scores_sorted.php" class="btn btn-danger btn-sm">Reset</a>                 
        </div>
        <hr class="no-margin"/>
    </form>
    ...
    <div class="wrapper2"> 
        ...
        <table class="table table-bordered">
            <thead class="bg-primary">
                <tr><th colspan="9">  BBGS CONTRACTORS SCORES-SORTED</th></tr>
            <tr>
