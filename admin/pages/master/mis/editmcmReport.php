...
$majorActivities    =   @$fetchalldata[4];
$majorActivities2   =   @$fetchalldata[5];
$majorActivities3   =   @$fetchalldata[2];
$majorActivities4   =   @$fetchalldata[6];
...
<div class="container1">
    ...
    <h1 class="heading">2. MCM Report
        <?php echo ( $mode == "view" ) ? '<a style="float: right;" href="mcmReportlist.php" class="btn btn-danger btn-xs">Back</a>' : ''; ?>
    </h1>    
    <div class="wrapper2">    
		...
		<div class="mcm_print">
            ...
            <td width="40%" >' . $activityview->name . '</td>
                <td align="center">' . $activityview->last_year_total . '</td>
                <td align="center">' . $activityview->target . '</td>
                <td align="center">' . $activityview->total_in_this_month . '</td>
                <td align="center">' . $activityview->ytm_total . '</td>
            </tr>';
                }
                echo ' </table>';
                ?>
            ...
            <th width="15%">Actual ' . $prev_FY . '</th>'
                ...
                foreach ($majorActivities2 as $key => $activityview2) {
                    echo '<tr>
                <td width="40%" >' . $activityview2->name . '</td>
                <td align="center">' . $activityview2->last_year_total . '</td>
                <td align="center">' . $activityview2->target . '</td>
                <td align="center">' . $activityview2->total_in_this_month . '</td>
                <td align="center">' . $activityview2->ytm_total . '</td>
            </tr>';
                ...
                foreach ($majorActivities3 as $key => $activityview3) {
                    echo '<tr><td width="40%" >' . $activityview3->name . '</td>'
                    . '<td align="center">' . $activityview3->last_year_total . '</td>'
                    . '<td align="center">' . $activityview3->total_in_this_month . '</td>'
                    . '<td align="center">' . $activityview3->ytm_total . '</td></tr>';
                }
                echo ' </table>';
                ?>
			</div>
...
<script type="text/javascript">
    function PrintDiv()
    {
        ...
        mywindow.document.write('<style>@page{margin:25mm 20mm 20mm 20mm;}table{border-collapse:collapse;margin-bottom:15px;}table th, table td {border:1px solid #80aaff;border-collapse:collapse;}table th {background: #88b5dd !important;-webkit-print-color-adjust: exact;color-adjust: exact;border:1px solid #609dd2;}th {color:#ffffff !important;}.mcm_print{height:245mm;}</style></head><body>');
