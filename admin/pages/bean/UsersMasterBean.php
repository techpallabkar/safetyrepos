...
//		if( $full_name == "" ) {
//			$this->error_messages[ "full_name_error" ] = "<div class=\"errors\">Fullname is required.</div>";
//			$error_counter++;
//		}
		if( $employee_code == "" ) {
			$this->error_messages[ "employee_code_error" ] = "<div class=\"errors\">Username is required.</div>";
			$error_counter++;
		}
//		if( $mobile_no == "" ) {
...
//		}
		if( $role_id == "" ) {
			$this->error_messages[ "role_id_error" ] = "<div class=\"errors\">User type is required.</div>";
			$error_counter++;
		}
