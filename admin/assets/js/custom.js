...
jQuery(function () {
    ...
    $MENU_TOGGLE.on('click', function() {
        if ($BODY.hasClass('nav-md')) {
            ...
            jQuery(".toggle .fa").removeClass("fa-angle-double-left").addClass("fa-angle-double-right");
            ...
            jQuery(".toggle .fa").removeClass("fa-angle-double-right").addClass("fa-angle-double-left");
            $SIDEBAR_FOOTER.show();
